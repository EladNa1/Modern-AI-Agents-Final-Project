...
async def agent_info():
    ...
    return {
        "description": (
            ...
            "are checked symbolically offline with SymPy (e.g. the Q2b root-count key, settled "
            "by the check during a ground-truth dispute). Every run is bounded in TIME as well "
